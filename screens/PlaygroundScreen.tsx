...
export default function PlaygroundScreen(
  _props: RootStackScreenProps<"Playground">,
) {
      ...
      <View style={styles.section}>
        ...
        {prepareError && (
          <Text style={styles.error}>
            Error preparing: {prepareError.message}
          </Text>
        )}
        ...
        {prepared?.type === "not-enough-balance-for-gas" && (
          <View style={styles.warningContainer}>
            ...
            <Text style={styles.warningText}>
              You don't have enough balance to cover the gas fee. You can pay
              gas with any of these tokens:{" "}
              {prepared.feeCurrencies.map((fc) => fc.symbol).join(", ")}.
            </Text>
          </View>
        )}
        ...
        {/* Send Error */}
        {sendError && (
          <Text style={styles.error}>Error sending: {sendError.message}</Text>
        )}
